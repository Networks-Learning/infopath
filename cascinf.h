...
public:
  ...
  // functions to generate synthetic networks & cascades
  void GenerateGroundTruth(const int& TNetwork, const int& NNodes, const int& NEdges, const TStr& NetworkParams);
  void GenerateAlphas(const TStr& RAlphas, const TStr& VaryingType, const double& ResolutionPerEdge, const TStr& VaryingTypeParameter=TStr("1.0"));
